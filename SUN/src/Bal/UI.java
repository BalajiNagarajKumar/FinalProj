			...
			public void actionPerformed(ActionEvent arg0) {
				...
				*/
				...
				KmeansClustering Kmean1 = new KmeansClustering();
					...
					count= Kmean1.counter();
				
				lblCentroid1.setText("Centroid 1: " + count[0] + " samples " );
				lblCentroid2.setText("Centroid 2: " + count[1] + " samples " );
				lblCentroid3.setText("Centroid 3: " + count[2] + " samples " );
				lblCentroid4.setText("Centroid 4: " + count[3] + " samples " );
